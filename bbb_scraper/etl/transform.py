...
def transform_summary(summary: BusinessSummary) -> dict[str, Any]:
    record = {
        ...
        "bbb_office_id": summary.bbb_office_id,
        "bbb_office_name": summary.bbb_office_name,
        "search_category_id": summary.search_category_id,
        "search_category_name": summary.search_category_name,
...
def transform_detail(detail: BusinessDetail) -> dict[str, Any]:
    record = {
        ...
        "bbb_office_id": detail.bbb_office_id,
        "bbb_office_name": detail.bbb_office_name,
        "is_multi_location": detail.is_multi_location,
        ...
        "organization_description": detail.organization_description,
